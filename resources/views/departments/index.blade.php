                        ...
                        <table class="min-w-full table-fixed border-collapse">
                            <thead>
                                <tr class="glassmorphism-header text-white uppercase text-sm leading-normal">
                                    ...
                                    <th class="py-3 px-6 text-center font-semibold glass-table-heading">Users Count</th>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-white/10 transition-all duration-150">
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                ...
                                                <span class="glass-table-text text-white truncate max-w-[220px]">{{ $department->name }}</span>
                                            </div>
                                        </td>
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                ...
                                                <span class="glass-table-text text-white truncate max-w-[360px]">{{ $department->description }}</span>
                                            </div>
                                        </td>
                                        <td class="py-4 px-6 text-center">
                                            <div class="inline-flex items-center justify-center">
                                                ...
                                                <span
                                                    class="inline-flex items-center justify-center h-8 px-3 py-1 rounded-full text-sm font-semibold whitespace-nowrap glass-badge bg-blue-500/20 text-blue-200">
                                        ...
                                        <td class="py-4 px-6 text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                <a href="{{ route('departments.edit', $department) }}" title="Edit" aria-label="Edit"
